        ...
        try {
            database.use {
                insert(FavoriteMatch.TABLE_FAVORITE,
                        FavoriteMatch.ID_EVENT to eventsData.eventId,
                        FavoriteMatch.LEAGUE_ID to eventsData.leagueId,
                        FavoriteMatch.AWAY_ID to eventsData.homeTeamId,
                        FavoriteMatch.HOME_ID to eventsData.awayTeamId,
                        FavoriteMatch.DATE to eventsData.dateOfMatch,
                        FavoriteMatch.HOME_SCORE to eventsData.homeScore,
                        FavoriteMatch.AWAY_SCORE to eventsData.awayScore,
